  ...
  return (
    <div className="w-[170px] h-[220px] flex flex-col justify-center items-center space-y-1 bg-bege-two rounded-lg mt-5 shadow-black/40 shadow-lg">
      ...
      <div className="w-full flex justify-center pt-3">
        <button onClick={(e) => getFilter(e)} className="w-20 h10 bg-[#1C1C1C] border border-button rounded-md flex justify-center p-[2px] text-white font-bold active:bg-[#1C1C1C]/40">
          Submit
        </button>
      </div>
    </div>
