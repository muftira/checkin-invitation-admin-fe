...
const base_url = "https://checkin-invitation-be.vercel.app/api";

export const getData = () => axios.get(base_url + "/guest");

export const postData = (name, address) =>
  axios.post(base_url + "/guest", { name, address });

export const deleteData = (id) => axios.delete(base_url + "/guest/" + id);
